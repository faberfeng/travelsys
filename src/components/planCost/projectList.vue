<template>
    <div id="projectList">
            ...
            <div  class="screenRight_1">
                <div v-if="showProperty">
                    ...
                    <ul id="genealAtt" :class="[{'show':show.generalDesignInfo},'Att']">
                        <li class="detial-item clearfix">
                            <span class="detial-text-name">导入名称</span>
                            <span class="detial-text-value" :title="mapInfo['导入名称']">{{mapInfo['导入名称']}}</span>
                        </li>
                        <li class="detial-item clearfix">
                            <span class="detial-text-name">类型标记</span>
                            <span class="detial-text-value" :title="mapInfo['类型标记']">{{mapInfo['类型标记']}}</span>
                        </li>
                        <li class="detial-item clearfix">
                            <span class="detial-text-name">宽度</span>
                            <span class="detial-text-value" :title="mapInfo['宽度']">{{mapInfo['宽度']}}</span>
                        </li>
                        <li class="detial-item clearfix">
                            <span class="detial-text-name">元素标记</span>
                            <span class="detial-text-value" :title="mapInfo['元素标记']">{{mapInfo['元素标记']}}</span>
                        </li>
                        <li class="detial-item clearfix">
                            <span class="detial-text-name">对象父类型</span>
                            <span class="detial-text-value" :title="mapInfo['对象父类型']">{{mapInfo['对象父类型']}}</span>
                        </li>
                        <li class="detial-item clearfix">
                            <span class="detial-text-name">导入类型</span>
                            <span class="detial-text-value" :title="mapInfo['导入类型']">{{mapInfo['导入类型']}}</span>
                        </li>
                        <li class="detial-item clearfix">
                            <span class="detial-text-name">建筑标记</span>
                            <span class="detial-text-value" :title="mapInfo['建筑标记']">{{mapInfo['建筑标记']}}</span>
                        </li>
                        <li class="detial-item clearfix">
                            <span class="detial-text-name">所在文档</span>
                            <span class="detial-text-value" :title="mapInfo['所在文档']">{{mapInfo['所在文档']}}</span>
                        </li>
                        <li class="detial-item clearfix">
                            <span class="detial-text-name">导入编号</span>
                            <span class="detial-text-value" :title="mapInfo['导入编号']">{{mapInfo['导入编号']}}</span>
                        </li>
                        <li class="detial-item clearfix">
                            <span class="detial-text-name">元素注释</span>
                            <span class="detial-text-value" :title="mapInfo['元素注释']">{{mapInfo['元素注释']}}</span>
                        </li>
                        <li class="detial-item clearfix">
                            <span class="detial-text-name">高度</span>
                            <span class="detial-text-value" :title="mapInfo['高度']">{{mapInfo['高度']}}</span>
                        </li>
                    </ul>
                    <h3 class="header-attribute" style="margin-top: 33px;">
                        <i class="trrangle"></i>
        ...
        <!-- <div id="edit">
            ...
            <el-dialog title="请确认" :visible.sync="editSingleProperty.showWaring" :before-close="showWaringCancel">
                <div class="editBody">
                    <p>
