        ...
        <div class="loginBody">
            <div style="width:1200px;margin:0 auto;height:100%;position:relative;">
                ...
                <div class="loginDialog">
                    ...
                    <div class="loginInfo">
                        <a class="loginInfoLeft" href="http://10.252.26.240:8080/bimServer-usercenter/register/registerIndex" target="blank">立即注册</a>
                        <a class="loginInfoRight" href="http://10.252.26.240:8080/bimServer-usercenter/register/forgetPwd" target="blank">忘记密码</a>
                    </div>
