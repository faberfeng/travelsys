    ...
    <div id="projectNavigation">
        ...
        <div  class="noproject" v-show="noprojectShow">
            ...
            <div class="noprojectRight">
                ...
                您有以下几种选择：<br/>
                第一种：退出您自己的账号，采用共同账号winter（密码:123654）体验和学习已经拥有数据的项目。<br/>第二种：如果您的同事已经开通了项目，请联系您的同事，将您的账号添加到工程协作名单中。<br/>第三种：如果您有自己负责的项目，可以联系销售服务人员，作为工程管理员申请开通一个新的项目。<br/>如有其它疑问或索取学习资料，请加入BDMS客服QQ群：855923282
                </div>
                <div></div>
            </div>
        </div>
