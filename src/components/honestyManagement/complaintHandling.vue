...
export default {
    ...
    methods:{
         loadingTitle(){
          var vn=this;
          vn.routerList=vn.getSecondGradeList(vn.moduleList,'055','05504','/honestyManagement/complaintHandling','05503','/honestyManagement/badRecord','05502','/honestyManagement/goodRecord','05501','/honestyManagement/allEvaluate');
