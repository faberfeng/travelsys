<template>
    <div id="content">
        ...
        <div class="contentBody" >
         ...
         <div id="edit">
                <el-dialog title="添加良好记录" v-dialogDrag :visible.sync="addDialog" @close="addCancle">
                    <div class="editBody">
                        ...
                        <div @click="clickSelectUser" class="tagLable" style="text-align:left;display:inline-block;width:415px;height:50px;border:1px solid #d1d1d1;border-radius:4px;position:relative;vertical-align: middle;overflow:auto;">
                            <el-tag 
...
export default {
    ...
    methods:{
         loadingTitle(){
          var vn=this;
          vn.routerList=vn.getSecondGradeList(vn.moduleList,'055','05502','/honestyManagement/goodRecord','05501','/honestyManagement/allEvaluate','05503','/honestyManagement/badRecord','05504','/honestyManagement/complaintHandling');
