<template>
    <div id="wuliaoBody">
        <div  class="topHeader">
            ...
            <div style="margin-top:20px;padding:0px;box-sizing: border-box;margin-right:5px;">
...
export default {
    ...
    methods:{
        loadingTitle(){
            var vn=this;
            vn.routerList=vn.getSecondGradeList(vn.moduleList,'012','01202','/Cost/goujianList','01201','/Cost/management','01203','/Cost/quantities','01204','/Cost/inventory','01205','/Cost/wuliaoList');
                    ...
                    if(response.data.cd==0){
                        // if(response.data.rt){}
                            ...
                            if(vm.options_monomer.length>0){
                                ...
                                vm.value_monomerName = vm.options_monomer[0].Name
                            }
                    }
                })
            },
