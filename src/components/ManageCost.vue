        ...
        <div class="contentBody">
            ...
            <div v-show="webGlShow" class="webglBackground">
                <div id="webgl" v-show="webGlShow">
                    <iframe  ref="iframe1" :class="[{'webIframe':webGlShow},'webIframe1']" name="ifd" id='webglIframe'   frameborder="no" border="0" marginwidth="0" marginheight="0"  width="100%" src="http://bdms.arctron.cn/genDist/index.html"  ></iframe>
                </div>
            </div>
            <div  class="main">
                <div class="content">
