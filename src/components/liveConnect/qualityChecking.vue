...
export default {
    ...
    methods:{
        loadingTitle(){
          var vn=this;
          vn.routerList=vn.getSecondGradeList(vn.moduleList,'016','01603','/liveConnect/qualityChecking','01602','/liveConnect/fieldMessage','01601','/liveConnect/fieldConnection','01604','/liveConnect/qualityAcceptance');
